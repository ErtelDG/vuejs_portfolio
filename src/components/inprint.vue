...
<template><div class="min-w-min h-full bg-tertiary text-white grid grid-cols-12 grid-rows-none">
  <div
    ...
    (click)="openCloseInprint()">

    <svg enable-background="new 0 0 24 24" version="1.1" viewBox="0 0 24 24" xml:space="preserve" width="1.5rem"
      height="1.5rem" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <g id="grid_system" />
      <g id="_icons">
        <path
  ...
  <div
    ...
    <h1 class="text-2xl">Impressum</h1><br>
    <h2>Angaben gemäß § 5 TMG:</h2><br>
    <p><br>Dennis Georg Ertel</p><br>
    <h3>Postanschrift:</h3>
    <br>
    <h3>Kontakt:</h3>
    <p>Telefon: +49 162 1531349<br>E-Mail: contact@dennisgeorgertel.com</p><br>
    <br>
    <br>
    <h2>Hinweise zur Website</h2><br>
    <br>
    <h2>Information gemäß § 36 VSBG</h2><br>
    <p>Gemäß § 36 VSBG (Verbraucherstreitbeilegungsgesetz – Gesetz über die alternative Streitbeilegung in
      Verbrauchersachen) erklärt der Betreiber dieser Website:</p><br>
    ...
    <p><em>Das Impressum wurde mit dem <a
          href="https://www.activemind.de/datenschutz/impressums-generator/">Impressums-Generator der activeMind AG</a>
        erstellt.</em></p><br>
    <br><br>

    <h1 class="text-2xl">Datenschutzerklärung</h1><br>
    <p>Verantwortlicher im Sinne der Datenschutzgesetze, insbesondere der EU-Datenschutzgrundverordnung (DSGVO), ist:
    </p><br>
    <p>Dennis Georg Ertel</p><br>
    ...
    <p>Eine Liste der Aufsichtsbehörden (für den nichtöffentlichen Bereich) mit Anschrift finden Sie unter: <a
        ...
        rel="noopener nofollow">https://www.bfdi.bund.de/DE/Service/Anschriften/Laender/Laender-node.html</a>.</p><br>
    <p></p><br>
    ...
    <p>Wenn Sie auf unsere Website zugreifen, d.h., wenn Sie sich nicht registrieren oder anderweitig Informationen
      ...
      Internet-Service-Providers, Ihre IP-Adresse und ähnliches. </p><br>
    <p>Sie werden insbesondere zu folgenden Zwecken verarbeitet:</p><br>
    <ul>
    ...
    <p>Die von Ihnen eingegebenen Daten werden zum Zweck der individuellen Kommunikation mit Ihnen gespeichert. Hierfür
      ...
      der
      anschließenden Beantwortung derselben. Die Angabe weiterer Daten ist optional.</p><br>
    <h3>Rechtsgrundlage:</h3>
    <p>Die Verarbeitung der in das Kontaktformular eingegebenen Daten erfolgt auf der Grundlage eines berechtigten
      Interesses (Art. 6 Abs. 1 lit. f DSGVO).</p><br>
    ...
    <p>Sofern Sie mit uns Kontakt aufnehmen, um ein Angebot zu erfragen, erfolgt die Verarbeitung der in das
      Kontaktformular
      eingegebenen Daten zur Durchführung vorvertraglicher Maßnahmen (Art. 6 Abs. 1 lit. b DSGVO).</p><br>
    <h3>Empfänger:</h3>
    <p>Empfänger der Daten sind ggf. Auftragsverarbeiter.</p><br>
    <p></p><br>
    <h3>Speicherdauer:</h3>
    <p>Daten werden spätestens 6 Monate nach Bearbeitung der Anfrage gelöscht.</p><br>
    <p>Sofern es zu einem Vertragsverhältnis kommt, unterliegen wir den gesetzlichen Aufbewahrungsfristen nach HGB und
      löschen Ihre Daten nach Ablauf dieser Fristen. </p><br>
    <h3>Bereitstellung vorgeschrieben oder erforderlich:</h3>
    <p>Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig. Wir können Ihre Anfrage jedoch nur
      bearbeiten,
      sofern Sie uns Ihren Namen, Ihre E-Mail-Adresse und den Grund der Anfrage mitteilen.</p><br>
    <p></p><br>
    ...
    <p>Um unsere Inhalte browserübergreifend korrekt und grafisch ansprechend darzustellen, verwenden wir auf dieser
      ...
      zur
      Darstellung von Schriften.</p><br>
    <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a href="https://developers.google.com/fonts/faq"
      ...
      von Google: <a href="https://www.google.com/policies/privacy/" rel="noopener nofollow"
        target="_blank">https://www.google.com/policies/privacy/</a>.</p><br>
    <p></p><br>
    ...
    <p>Um die Sicherheit Ihrer Daten bei der Übertragung zu schützen, verwenden wir dem aktuellen Stand der Technik
      entsprechende Verschlüsselungsverfahren (z. B. SSL) über HTTPS.</p><br>
    <p></p><br>
    <hr>
    ...
    <p>Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen die
      ...
      Grundlage
      einer Interessenabwägung) erfolgt, Widerspruch einzulegen; dies gilt auch für ein auf diese Bestimmung gestütztes
      Profiling im Sinne von Art. 4 Nr. 4 DSGVO.</p><br>
    <p>Legen Sie Widerspruch ein, werden wir Ihre personenbezogenen Daten nicht mehr verarbeiten, es sei denn, wir
      ...
      überwiegen,
      oder die Verarbeitung dient der Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen.</p><br>
    <h3>Empfänger eines Widerspruchs</h3>
    <p>Dennis Georg Ertel
      <br>Telefon: +49 162 1531349
      <br>E-Mail: contact@dennisgeorgertel.com
    </p><br>
    <hr>
    ...
    <p>Wir behalten uns vor, diese Datenschutzerklärung anzupassen, damit sie stets den aktuellen rechtlichen
      ...
      neuer
      Services. Für Ihren erneuten Besuch gilt dann die neue Datenschutzerklärung.</p><br>
    ...
    <p>Wenn Sie Fragen zum Datenschutz haben, schreiben Sie uns bitte eine E-Mail oder wenden Sie sich direkt an die für
      den
      Datenschutz verantwortliche Person in unserer Organisation:</p><br>
    <p></p><br>
    <p><em>Die Datenschutzerklärung wurde mithilfe der activeMind AG erstellt, den Experten für <a
          ...
          Datenschutzbeauftragte</a> (Version #2020-09-30).</em></p><br>
