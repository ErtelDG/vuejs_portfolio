...
<template>
   <div class="grid grid-cols-12 row-span-full grid-rows-4 text-white text-center gap-4">
      ...
      <div class="row-start-3 row-span-1 col-start-3 col-end-11 lg:col-start-5 lg:col-end-9 xl:col-start-10 xl:col-end-13 xl:row-start-1 xl:row-span-1">
         <div class="col-start-4 col-end-10 flex justify-center  gap-4 items-center h-8">
