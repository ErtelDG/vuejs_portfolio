...
<template>
   ...
   <div :class="{ 'bg-tertiary': !store.state.menuOpen || !store.state.inprintOpen }" class="min-w-full gap-4">
      ...
      >
         <div class="col-span-full grid grid-cols-12 xl:grid-rows-4 gap-4">
            ...
            <component
               :is="components.greeting"
               class="col-span-full mt-4 xl:mt-0 xl:col-start-7 xl:col-end-12 xl:row-start-2 xl:row-end-4 xl:z-10"
            ></component>
            <component
               :is="components.social_links"
               class="col-span-full xl:col-start-1 xl:col-end-12 xl:row-start-4 xl:row-end-5 xl:z-10 xl:mt-16"
            ></component>
   ...
   <component :is="components.inprint" class="min-w-full gap-4 text-white"></component>
</template>
